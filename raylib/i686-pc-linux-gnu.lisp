;; Generated by :claw at 2024-05-16T12:41:10.097768Z
...
(defparameter raylib::+m-1-pi+ 0.3183098861837907D0)

(defparameter raylib::+m-2-pi+ 0.6366197723675814D0)

(defparameter raylib::+m-2-sqrtpi+ 1.1283791670955126D0)

(defparameter raylib::+m-e+ 2.718281828459045D0)

(defparameter raylib::+m-ln10+ 2.302585092994046D0)

(defparameter raylib::+m-ln2+ 0.6931471805599453D0)

(defparameter raylib::+m-log10e+ 0.4342944819032518D0)

(defparameter raylib::+m-log2e+ 1.4426950408889634D0)

(defparameter raylib::+m-pi+ 3.141592653589793D0)

(defparameter raylib::+m-pi-2+ 1.5707963267948966D0)

(defparameter raylib::+m-pi-4+ 0.7853981633974483D0)

(defparameter raylib::+m-sqrt1-2+ 0.7071067811865476D0)

(defparameter raylib::+m-sqrt2+ 1.4142135623730951D0)
...
(defparameter raylib::+%atfile-source+ 1)
...
(defparameter raylib::+%default-source+ 1)

(defparameter raylib::+%features-h+ 1)

(defparameter raylib::+%ilp32+ 1)

(defparameter raylib::+%math-h+ 1)

(defparameter raylib::+%mdouble-+ nil)

(defparameter raylib::+%posix-c-source+ 200809)

(defparameter raylib::+%posix-source+ 1)
...
(defparameter raylib::+i386+ nil)

(defparameter raylib::+linux+ nil)

(defparameter raylib::+math-errhandling+ 3)

(defparameter raylib::+true+ 1)

(defparameter raylib::+unix+ nil)
...
(cffi:defcstruct (raylib::audio-stream :size 20)
                 (raylib::buffer (:pointer raylib::r-audio-buffer)
                  :offset 0)
                 (raylib::processor
                  (:pointer raylib::r-audio-processor) :offset 4)
                 (raylib::sample-rate :unsigned-int :offset 8)
                 (raylib::sample-size :unsigned-int :offset 12)
                 (raylib::channels :unsigned-int :offset 16))
...
(cffi:defcfun ("__claw_BeginMode2D" raylib::begin-mode-2d)
              :void
...
(cffi:defcfun ("__claw_BeginMode3D" raylib::begin-mode-3d)
              :void
...
(cffi:defcstruct (raylib::shader :size 8)
                 (raylib::id :unsigned-int :offset 0)
                 (raylib::locs (:pointer :int) :offset 4))

(cffi:defctype raylib::shader (:struct raylib::shader))

(declaim (inline raylib::begin-shader-mode))

(cffi:defcfun ("__claw_BeginShaderMode" raylib::begin-shader-mode)
              :void
...
(cffi:defcfun ("__claw_BeginTextureMode" raylib::begin-texture-mode)
              :void
...
(cffi:defcfun ("__claw_Clamp" raylib::clamp)
              :float
              (raylib::value :float)
              (raylib::min :float)
              (raylib::max :float))
...
(cffi:defcfun ("__claw_ClearBackground" raylib::clear-background)
              :void
...
(cffi:defcfun ("__claw_ColorAlpha" raylib::color-alpha)
...
(cffi:defcfun ("__claw_ColorAlphaBlend" raylib::color-alpha-blend)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
...
(cffi:defcfun ("__claw_ColorBrightness" raylib::color-brightness)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
              (raylib::color (:pointer raylib::color))
              (raylib::factor :float))
...
(cffi:defcfun ("__claw_ColorContrast" raylib::color-contrast)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
              (raylib::color (:pointer raylib::color))
...
(cffi:defcfun ("__claw_ColorFromHSV" raylib::color-from-hsv)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
              (raylib::hue :float)
...
(cffi:defcfun ("__claw_ColorNormalize" raylib::color-normalize)
...
(cffi:defcfun ("__claw_ColorTint" raylib::color-tint)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
              (raylib::color (:pointer raylib::color))
              (raylib::tint (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_ColorToHSV" raylib::color-to-hsv)
...
(cffi:defcfun ("__claw_ColorToInt" raylib::color-to-int)
              :int
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawBillboard" raylib::draw-billboard)
              :void
              (raylib::camera (:pointer raylib::camera))
...
(cffi:defcfun ("__claw_DrawBillboardPro" raylib::draw-billboard-pro)
              :void
              (raylib::camera (:pointer raylib::camera))
              (raylib::texture (:pointer raylib::texture-2d))
...
(cffi:defcfun ("__claw_DrawBillboardRec" raylib::draw-billboard-rec)
              :void
              (raylib::camera (:pointer raylib::camera))
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::source (:pointer raylib::rectangle))
...
(cffi:defcfun ("__claw_DrawBoundingBox" raylib::draw-bounding-box)
              :void
              (raylib::box (:pointer raylib::bounding-box))
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawCapsule" raylib::draw-capsule)
              :void
...
(cffi:defcfun ("__claw_DrawCapsuleWires" raylib::draw-capsule-wires)
              :void
              (raylib::start-pos (:pointer raylib::vector3))
              (raylib::end-pos (:pointer raylib::vector3))
              (raylib::radius :float)
...
(cffi:defcfun ("__claw_DrawCircle" raylib::draw-circle)
              :void
              (raylib::center-x :int)
              (raylib::center-y :int)
              (raylib::radius :float)
...
(cffi:defcfun ("__claw_DrawCircle3D" raylib::draw-circle-3d)
              :void
              (raylib::center (:pointer raylib::vector3))
              (raylib::radius :float)
...
(cffi:defcfun ("__claw_DrawCircleLines" raylib::draw-circle-lines)
              :void
              (raylib::center-x :int)
              (raylib::center-y :int)
              (raylib::radius :float)
...
(cffi:defcfun ("__claw_DrawCircleLinesV" raylib::draw-circle-lines-v)
              :void
              (raylib::center (:pointer raylib::vector2))
              (raylib::radius :float)
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawCircleSector" raylib::draw-circle-sector)
              :void
              (raylib::center (:pointer raylib::vector2))
              (raylib::radius :float)
...
(cffi:defcfun ("__claw_DrawCircleV" raylib::draw-circle-v)
              :void
              (raylib::center (:pointer raylib::vector2))
              (raylib::radius :float)
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawCube" raylib::draw-cube)
              :void
              (raylib::position (:pointer raylib::vector3))
              (raylib::width :float)
              (raylib::height :float)
...
(cffi:defcfun ("__claw_DrawCubeV" raylib::draw-cube-v)
              :void
              (raylib::position (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_DrawCubeWires" raylib::draw-cube-wires)
              :void
              (raylib::position (:pointer raylib::vector3))
              (raylib::width :float)
              (raylib::height :float)
...
(cffi:defcfun ("__claw_DrawCubeWiresV" raylib::draw-cube-wires-v)
              :void
              (raylib::position (:pointer raylib::vector3))
              (raylib::size (:pointer raylib::vector3))
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawCylinder" raylib::draw-cylinder)
              :void
              (raylib::position (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_DrawCylinderEx" raylib::draw-cylinder-ex)
              :void
              (raylib::start-pos (:pointer raylib::vector3))
              (raylib::end-pos (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_DrawEllipse" raylib::draw-ellipse)
              :void
              (raylib::center-x :int)
              (raylib::center-y :int)
...
(cffi:defcfun ("__claw_DrawEllipseLines" raylib::draw-ellipse-lines)
              :void
              (raylib::center-x :int)
              (raylib::center-y :int)
              (raylib::radius-h :float)
...
(cffi:defcfun ("__claw_DrawLine" raylib::draw-line)
              :void
...
(cffi:defcfun ("__claw_DrawLine3D" raylib::draw-line-3d)
              :void
              (raylib::start-pos (:pointer raylib::vector3))
              (raylib::end-pos (:pointer raylib::vector3))
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawLineBezier" raylib::draw-line-bezier)
              :void
...
(cffi:defcfun ("__claw_DrawLineEx" raylib::draw-line-ex)
              :void
              (raylib::start-pos (:pointer raylib::vector2))
              (raylib::end-pos (:pointer raylib::vector2))
              (raylib::thick :float)
...
(cffi:defcfun ("__claw_DrawLineStrip" raylib::draw-line-strip)
              :void
              (raylib::points (:pointer raylib::vector2))
              (raylib::point-count :int)
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawLineV" raylib::draw-line-v)
              :void
              (raylib::start-pos (:pointer raylib::vector2))
              (raylib::end-pos (:pointer raylib::vector2))
              (raylib::color (:pointer raylib::color)))

(cffi:defcstruct (raylib::mesh :size 60)
                 (raylib::vertex-count :int :offset 0)
                 (raylib::triangle-count :int :offset 4)
                 (raylib::vertices (:pointer :float) :offset 8)
                 (raylib::texcoords (:pointer :float) :offset 12)
                 (raylib::texcoords2 (:pointer :float) :offset 16)
                 (raylib::normals (:pointer :float) :offset 20)
                 (raylib::tangents (:pointer :float) :offset 24)
                 (raylib::colors (:pointer :unsigned-char) :offset
                  28)
                 (raylib::indices (:pointer :unsigned-short) :offset
                  32)
                 (raylib::anim-vertices (:pointer :float) :offset 36)
                 (raylib::anim-normals (:pointer :float) :offset 40)
                 (raylib::bone-ids (:pointer :unsigned-char) :offset
                  44)
                 (raylib::bone-weights (:pointer :float) :offset 48)
                 (raylib::vao-id :unsigned-int :offset 52)
                 (raylib::vbo-id (:pointer :unsigned-int) :offset 56))
...
(cffi:defcstruct (raylib::model :size 96)
                 ...
                 (raylib::materials (:pointer raylib::material)
                  :offset 76)
                 (raylib::mesh-material (:pointer :int) :offset 80)
                 (raylib::bone-count :int :offset 84)
...
(cffi:defcfun ("__claw_DrawModel" raylib::draw-model)
              :void
...
(cffi:defcfun ("__claw_DrawModelEx" raylib::draw-model-ex)
              :void
              (raylib::model (:pointer raylib::model))
              (raylib::position (:pointer raylib::vector3))
              (raylib::rotation-axis (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_DrawModelWires" raylib::draw-model-wires)
              :void
              (raylib::model (:pointer raylib::model))
              (raylib::position (:pointer raylib::vector3))
              (raylib::scale :float)
...
(cffi:defcfun ("__claw_DrawModelWiresEx" raylib::draw-model-wires-ex)
              :void
              (raylib::model (:pointer raylib::model))
              (raylib::position (:pointer raylib::vector3))
              (raylib::rotation-axis (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_DrawPixel" raylib::draw-pixel)
              :void
              (raylib::pos-x :int)
              (raylib::pos-y :int)
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawPixelV" raylib::draw-pixel-v)
              :void
...
(cffi:defcfun ("__claw_DrawPlane" raylib::draw-plane)
              :void
...
(cffi:defcfun ("__claw_DrawPoint3D" raylib::draw-point-3d)
              :void
              (raylib::position (:pointer raylib::vector3))
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawPoly" raylib::draw-poly)
              :void
              (raylib::center (:pointer raylib::vector2))
              (raylib::sides :int)
              (raylib::radius :float)
...
(cffi:defcfun ("__claw_DrawPolyLines" raylib::draw-poly-lines)
              :void
              (raylib::center (:pointer raylib::vector2))
              (raylib::sides :int)
              (raylib::radius :float)
...
(cffi:defcfun ("__claw_DrawPolyLinesEx" raylib::draw-poly-lines-ex)
              :void
              (raylib::center (:pointer raylib::vector2))
              (raylib::sides :int)
              (raylib::radius :float)
...
(cffi:defcfun ("__claw_DrawRay" raylib::draw-ray)
              :void
...
(cffi:defcfun ("__claw_DrawRectangle" raylib::draw-rectangle)
              :void
              (raylib::pos-x :int)
              (raylib::pos-y :int)
              (raylib::width :int)
...
(cffi:defcfun ("__claw_DrawRectanglePro" raylib::draw-rectangle-pro)
              :void
              (raylib::rec (:pointer raylib::rectangle))
              (raylib::origin (:pointer raylib::vector2))
              (raylib::rotation :float)
...
(cffi:defcfun ("__claw_DrawRectangleRec" raylib::draw-rectangle-rec)
              :void
              (raylib::rec (:pointer raylib::rectangle))
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawRectangleV" raylib::draw-rectangle-v)
              :void
              (raylib::position (:pointer raylib::vector2))
              (raylib::size (:pointer raylib::vector2))
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawRing" raylib::draw-ring)
              :void
              (raylib::center (:pointer raylib::vector2))
...
(cffi:defcfun ("__claw_DrawRingLines" raylib::draw-ring-lines)
              :void
              (raylib::center (:pointer raylib::vector2))
              (raylib::inner-radius :float)
              (raylib::outer-radius :float)
...
(cffi:defcfun ("__claw_DrawSphere" raylib::draw-sphere)
              :void
              (raylib::center-pos (:pointer raylib::vector3))
              (raylib::radius :float)
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawSphereEx" raylib::draw-sphere-ex)
              :void
              (raylib::center-pos (:pointer raylib::vector3))
              (raylib::radius :float)
              (raylib::rings :int)
...
(cffi:defcfun ("__claw_DrawSphereWires" raylib::draw-sphere-wires)
              :void
              (raylib::center-pos (:pointer raylib::vector3))
              (raylib::radius :float)
              (raylib::rings :int)
...
(cffi:defcfun ("__claw_DrawSplineBasis" raylib::draw-spline-basis)
              :void
              (raylib::points (:pointer raylib::vector2))
              (raylib::point-count :int)
              (raylib::thick :float)
...
(cffi:defcfun ("__claw_DrawSplineBezierCubic"
...
(cffi:defcfun ("__claw_DrawSplineBezierQuadratic"
...
(cffi:defcfun ("__claw_DrawSplineCatmullRom"
...
(cffi:defcfun ("__claw_DrawSplineLinear" raylib::draw-spline-linear)
              :void
              (raylib::points (:pointer raylib::vector2))
              (raylib::point-count :int)
              (raylib::thick :float)
...
(cffi:defcfun ("__claw_DrawSplineSegmentBasis"
...
(cffi:defcfun ("__claw_DrawSplineSegmentBezierCubic"
...
(cffi:defcfun ("__claw_DrawSplineSegmentBezierQuadratic"
...
(cffi:defcfun ("__claw_DrawSplineSegmentCatmullRom"
...
(cffi:defcfun ("__claw_DrawSplineSegmentLinear"
...
(cffi:defcfun ("__claw_DrawText" raylib::draw-text)
              :void
              (raylib::text :string)
              (raylib::pos-x :int)
              (raylib::pos-y :int)
...
(cffi:defcstruct (raylib::image :size 20)
...
(cffi:defcstruct (raylib::glyph-info :size 36)
...
(cffi:defcstruct (raylib::font :size 40)
...
(cffi:defcfun ("__claw_DrawTextEx" raylib::draw-text-ex)
              :void
              (raylib::font (:pointer raylib::font))
              (raylib::text :string)
              (raylib::position (:pointer raylib::vector2))
...
(cffi:defcfun ("__claw_DrawTextPro" raylib::draw-text-pro)
              :void
              (raylib::font (:pointer raylib::font))
              (raylib::text :string)
              (raylib::position (:pointer raylib::vector2))
...
(cffi:defcfun ("__claw_DrawTexture" raylib::draw-texture)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::pos-x :int)
              (raylib::pos-y :int)
...
(cffi:defcfun ("__claw_DrawTextureEx" raylib::draw-texture-ex)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::position (:pointer raylib::vector2))
              (raylib::rotation :float)
...
(cffi:defcfun ("__claw_DrawTexturePro" raylib::draw-texture-pro)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::source (:pointer raylib::rectangle))
              (raylib::dest (:pointer raylib::rectangle))
...
(cffi:defcfun ("__claw_DrawTextureRec" raylib::draw-texture-rec)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::source (:pointer raylib::rectangle))
              (raylib::position (:pointer raylib::vector2))
...
(cffi:defcfun ("__claw_DrawTextureV" raylib::draw-texture-v)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::position (:pointer raylib::vector2))
              (raylib::tint (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawTriangle" raylib::draw-triangle)
              :void
...
(cffi:defcfun ("__claw_DrawTriangle3D" raylib::draw-triangle-3d)
              :void
...
(cffi:defcfun ("__claw_DrawTriangleFan" raylib::draw-triangle-fan)
              :void
              (raylib::points (:pointer raylib::vector2))
              (raylib::point-count :int)
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcstruct (raylib::automation-event-list :size 12)
...
(cffi:defcfun ("__claw_ExportAutomationEventList"
...
(cffi:defcfun ("__claw_ExportFontAsCode" raylib::export-font-as-code)
              :bool
              (raylib::font (:pointer raylib::font))
              (raylib::file-name :string))
...
(cffi:defcfun ("__claw_ExportImage" raylib::export-image)
              :bool
...
(cffi:defcfun ("__claw_ExportImageToMemory"
...
(cffi:defcfun ("__claw_ExportMesh" raylib::export-mesh)
              :bool
              (raylib::mesh (:pointer raylib::mesh))
              (raylib::file-name :string))

(cffi:defcstruct (raylib::wave :size 20)
...
(cffi:defcfun ("__claw_ExportWave" raylib::export-wave)
              :bool
...
(cffi:defcfun ("__claw_ExportWaveAsCode" raylib::export-wave-as-code)
              :bool
              (raylib::wave (:pointer raylib::wave))
              (raylib::file-name :string))
...
(cffi:defcfun ("__claw_Fade" raylib::fade)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
              (raylib::color (:pointer raylib::color))
              (raylib::alpha :float))
...
(cffi:defcfun ("__claw_FloatEquals" raylib::float-equals)
              :int
              (raylib::x :float)
              (raylib::y :float))
...
(cffi:defcfun ("__claw_GenImageCellular" raylib::gen-image-cellular)
...
(cffi:defcfun ("__claw_GenImageChecked" raylib::gen-image-checked)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::width :int)
              (raylib::height :int)
...
(cffi:defcfun ("__claw_GenImageColor" raylib::gen-image-color)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::width :int)
              (raylib::height :int)
...
(cffi:defcfun ("__claw_GenImageGradientLinear"
...
(cffi:defcfun ("__claw_GenImageGradientSquare"
...
(cffi:defcfun ("__claw_GenImageText" raylib::gen-image-text)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::width :int)
              (raylib::height :int)
...
(cffi:defcfun ("__claw_GenMeshCone" raylib::gen-mesh-cone)
              (:pointer raylib::mesh)
...
(cffi:defcfun ("__claw_GenMeshCube" raylib::gen-mesh-cube)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
              (raylib::width :float)
              (raylib::height :float)
...
(cffi:defcfun ("__claw_GenMeshCubicmap" raylib::gen-mesh-cubicmap)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
...
(cffi:defcfun ("__claw_GenMeshCylinder" raylib::gen-mesh-cylinder)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
              (raylib::radius :float)
              (raylib::height :float)
...
(cffi:defcfun ("__claw_GenMeshHeightmap" raylib::gen-mesh-heightmap)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
...
(cffi:defcfun ("__claw_GenMeshKnot" raylib::gen-mesh-knot)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
              (raylib::radius :float)
              (raylib::size :float)
...
(cffi:defcfun ("__claw_GenMeshPlane" raylib::gen-mesh-plane)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
              (raylib::width :float)
              (raylib::length :float)
...
(cffi:defcfun ("__claw_GenMeshPoly" raylib::gen-mesh-poly)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
              (raylib::sides :int)
              (raylib::radius :float))
...
(cffi:defcfun ("__claw_GenMeshSphere" raylib::gen-mesh-sphere)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
              (raylib::radius :float)
              (raylib::rings :int)
...
(cffi:defcfun ("__claw_GenMeshTorus" raylib::gen-mesh-torus)
              (:pointer raylib::mesh)
              (raylib::%%claw-result- (:pointer raylib::mesh))
              (raylib::radius :float)
              (raylib::size :float)
...
(cffi:defcfun ("__claw_GetCameraForward" raylib::get-camera-forward)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::camera (:pointer raylib::camera)))
...
(cffi:defcfun ("__claw_GetCameraMatrix" raylib::get-camera-matrix)
...
(cffi:defcfun ("__claw_GetCameraRight" raylib::get-camera-right)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::camera (:pointer raylib::camera)))
...
(cffi:defcfun ("__claw_GetCameraUp" raylib::get-camera-up)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::camera (:pointer raylib::camera)))
...
(cffi:defcfun ("__claw_GetCollisionRec" raylib::get-collision-rec)
...
(cffi:defcfun ("__claw_GetColor" raylib::get-color)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
...
(cffi:defcfun ("__claw_GetGlyphAtlasRec" raylib::get-glyph-atlas-rec)
              (:pointer raylib::rectangle)
              (raylib::%%claw-result- (:pointer raylib::rectangle))
              (raylib::font (:pointer raylib::font))
              (raylib::codepoint :int))
...
(cffi:defcfun ("__claw_GetGlyphIndex" raylib::get-glyph-index)
              :int
              (raylib::font (:pointer raylib::font))
              (raylib::codepoint :int))
...
(cffi:defcfun ("__claw_GetGlyphInfo" raylib::get-glyph-info)
...
(cffi:defcfun ("__claw_GetImageColor" raylib::get-image-color)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
              (raylib::image (:pointer raylib::image))
              (raylib::x :int)
...
(cffi:defcfun ("__claw_GetMouseRay" raylib::get-mouse-ray)
              (:pointer raylib::ray)
...
(cffi:defcstruct (raylib::music :size 36)
                 (raylib::stream raylib::audio-stream :offset 0)
                 (raylib::frame-count :unsigned-int :offset 20)
                 (raylib::looping :bool :offset 24)
                 (raylib::ctx-type :int :offset 28)
                 (raylib::ctx-data (:pointer :void) :offset 32))
...
(cffi:defcfun ("__claw_GetPixelColor" raylib::get-pixel-color)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
...
(cffi:defcfun ("__claw_GetSplinePointBasis"
...
(cffi:defcfun ("__claw_GetSplinePointBezierCubic"
...
(cffi:defcfun ("__claw_GetSplinePointBezierQuad"
...
(cffi:defcfun ("__claw_GetSplinePointCatmullRom"
...
(cffi:defcfun ("__claw_GetSplinePointLinear"
...
(cffi:defcfun ("__claw_GetTouchPosition" raylib::get-touch-position)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::index :int))
...
(cffi:defcfun ("__claw_GetWorldToScreen" raylib::get-world-to-screen)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::position (:pointer raylib::vector3))
              (raylib::camera (:pointer raylib::camera)))
...
(cffi:defcfun ("__claw_ImageAlphaClear" raylib::image-alpha-clear)
              :void
              (raylib::image (:pointer raylib::image))
              (raylib::color (:pointer raylib::color))
              (raylib::threshold :float))
...
(cffi:defcfun ("__claw_ImageAlphaMask" raylib::image-alpha-mask)
              :void
              (raylib::image (:pointer raylib::image))
...
(cffi:defcfun ("__claw_ImageColorTint" raylib::image-color-tint)
              :void
              (raylib::image (:pointer raylib::image))
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_ImageCopy" raylib::image-copy)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::image (:pointer raylib::image)))
...
(cffi:defcfun ("__claw_ImageCrop" raylib::image-crop)
              :void
              (raylib::image (:pointer raylib::image))
...
(cffi:defcfun ("__claw_ImageDraw" raylib::image-draw)
              :void
              (raylib::dst (:pointer raylib::image))
...
(cffi:defcfun ("__claw_ImageDrawCircle" raylib::image-draw-circle)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::center-x :int)
              (raylib::center-y :int)
...
(cffi:defcfun ("__claw_ImageDrawCircleV" raylib::image-draw-circle-v)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::center (:pointer raylib::vector2))
              (raylib::radius :int)
...
(cffi:defcfun ("__claw_ImageDrawLine" raylib::image-draw-line)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::start-pos-x :int)
              (raylib::start-pos-y :int)
...
(cffi:defcfun ("__claw_ImageDrawLineV" raylib::image-draw-line-v)
              :void
              (raylib::dst (:pointer raylib::image))
...
(cffi:defcfun ("__claw_ImageDrawPixel" raylib::image-draw-pixel)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::pos-x :int)
              (raylib::pos-y :int)
...
(cffi:defcfun ("__claw_ImageDrawPixelV" raylib::image-draw-pixel-v)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::position (:pointer raylib::vector2))
              (raylib::color (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_ImageDrawText" raylib::image-draw-text)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::text :string)
              (raylib::pos-x :int)
...
(cffi:defcfun ("__claw_ImageDrawTextEx" raylib::image-draw-text-ex)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::font (:pointer raylib::font))
              (raylib::text :string)
...
(cffi:defcfun ("__claw_ImageFromImage" raylib::image-from-image)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::image (:pointer raylib::image))
              (raylib::rec (:pointer raylib::rectangle)))
...
(cffi:defcfun ("__claw_ImageText" raylib::image-text)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::text :string)
              (raylib::font-size :int)
...
(cffi:defcfun ("__claw_ImageTextEx" raylib::image-text-ex)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::font (:pointer raylib::font))
              (raylib::text :string)
...
(cffi:defcfun ("__claw_ImageToPOT" raylib::image-to-pot)
              :void
              (raylib::image (:pointer raylib::image))
              (raylib::fill (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_IsFontReady" raylib::is-font-ready)
              :bool
              (raylib::font (:pointer raylib::font)))
...
(cffi:defcfun ("__claw_IsImageReady" raylib::is-image-ready)
              :bool
              (raylib::image (:pointer raylib::image)))
...
(cffi:defcfun ("__claw_IsMaterialReady" raylib::is-material-ready)
              :bool
              (raylib::material (:pointer raylib::material)))

(cffi:defcstruct (raylib::model-animation :size 48)
                 (raylib::bone-count :int :offset 0)
                 (raylib::frame-count :int :offset 4)
                 (raylib::bones (:pointer raylib::bone-info) :offset
                  8)
                 (raylib::frame-poses
                  (:pointer (:pointer raylib::transform)) :offset 12)
                 (raylib::name :char :count 32 :offset 16))
...
(cffi:defcfun ("__claw_IsModelReady" raylib::is-model-ready)
              :bool
              (raylib::model (:pointer raylib::model)))
...
(cffi:defcfun ("__claw_IsMusicReady" raylib::is-music-ready)
              :bool
              (raylib::music (:pointer raylib::music)))
...
(cffi:defcfun ("__claw_IsShaderReady" raylib::is-shader-ready)
              :bool
              (raylib::shader (:pointer raylib::shader)))

(cffi:defcstruct (raylib::sound :size 24)
                 (raylib::stream raylib::audio-stream :offset 0)
                 (raylib::frame-count :unsigned-int :offset 20))
...
(cffi:defcfun ("__claw_IsSoundPlaying" raylib::is-sound-playing)
              :bool
              (raylib::sound (:pointer raylib::sound)))

(declaim (inline raylib::is-sound-ready))

(cffi:defcfun ("__claw_IsSoundReady" raylib::is-sound-ready)
              :bool
              (raylib::sound (:pointer raylib::sound)))

(declaim (inline raylib::is-texture-ready))

(cffi:defcfun ("__claw_IsTextureReady" raylib::is-texture-ready)
              :bool
              (raylib::texture (:pointer raylib::texture-2d)))

(declaim (inline raylib::is-wave-ready))

(cffi:defcfun ("__claw_IsWaveReady" raylib::is-wave-ready)
              :bool
              (raylib::wave (:pointer raylib::wave)))
...
(cffi:defcfun ("__claw_Lerp" raylib::lerp)
              :float
              (raylib::start :float)
              (raylib::end :float)
              (raylib::amount :float))
...
(cffi:defcfun ("__claw_LoadAudioStream" raylib::load-audio-stream)
...
(cffi:defcfun ("__claw_LoadAutomationEventList"
...
(cffi:defcstruct (raylib::file-path-list :size 12)
                 (raylib::capacity :unsigned-int :offset 0)
                 (raylib::count :unsigned-int :offset 4)
...
(cffi:defcfun ("__claw_LoadFont" raylib::load-font)
              (:pointer raylib::font)
              (raylib::%%claw-result- (:pointer raylib::font))
              (raylib::file-name :string))
...
(cffi:defcfun ("__claw_LoadFontEx" raylib::load-font-ex)
              (:pointer raylib::font)
              (raylib::%%claw-result- (:pointer raylib::font))
              (raylib::file-name :string)
              (raylib::font-size :int)
...
(cffi:defcfun ("__claw_LoadImage" raylib::load-image)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::file-name :string))
...
(cffi:defcfun ("__claw_LoadImageAnim" raylib::load-image-anim)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::file-name :string)
...
(cffi:defcfun ("__claw_LoadImageColors" raylib::load-image-colors)
              (:pointer raylib::color)
              (raylib::image (:pointer raylib::image)))
...
(cffi:defcfun ("__claw_LoadImagePalette" raylib::load-image-palette)
              (:pointer raylib::color)
              (raylib::image (:pointer raylib::image))
...
(cffi:defcfun ("__claw_LoadImageRaw" raylib::load-image-raw)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::file-name :string)
              (raylib::width :int)
...
(cffi:defcfun ("__claw_LoadImageSvg" raylib::load-image-svg)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
...
(cffi:defcfun ("__claw_LoadModel" raylib::load-model)
...
(cffi:defcfun ("__claw_LoadMusicStream" raylib::load-music-stream)
...
(cffi:defcfun ("__claw_LoadShader" raylib::load-shader)
...
(cffi:defcfun ("__claw_LoadSound" raylib::load-sound)
...
(cffi:defcfun ("__claw_LoadSoundAlias" raylib::load-sound-alias)
              (:pointer raylib::sound)
              (raylib::%%claw-result- (:pointer raylib::sound))
...
(cffi:defcfun ("__claw_LoadTexture" raylib::load-texture)
...
(cffi:defcfun ("__claw_LoadWave" raylib::load-wave)
              (:pointer raylib::wave)
...
(cffi:defcfun ("__claw_LoadWaveSamples" raylib::load-wave-samples)
              (:pointer :float)
              (raylib::wave (:pointer raylib::wave)))

(declaim (inline raylib::matrix-add))

(cffi:defcfun ("__claw_MatrixAdd" raylib::matrix-add)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
...
(cffi:defcfun ("__claw_MatrixDeterminant" raylib::matrix-determinant)
              :float
              (raylib::mat (:pointer raylib::matrix)))

(declaim (inline raylib::matrix-frustum))

(cffi:defcfun ("__claw_MatrixFrustum" raylib::matrix-frustum)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::left :double)
              (raylib::right :double)
...
(cffi:defcfun ("__claw_MatrixInvert" raylib::matrix-invert)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::mat (:pointer raylib::matrix)))
...
(cffi:defcfun ("__claw_MatrixLookAt" raylib::matrix-look-at)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
...
(cffi:defcfun ("__claw_MatrixMultiply" raylib::matrix-multiply)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::left (:pointer raylib::matrix))
              (raylib::right (:pointer raylib::matrix)))
...
(cffi:defcfun ("__claw_MatrixOrtho" raylib::matrix-ortho)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::left :double)
              (raylib::right :double)
...
(cffi:defcfun ("__claw_MatrixPerspective" raylib::matrix-perspective)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::fov-y :double)
...
(cffi:defcfun ("__claw_MatrixRotate" raylib::matrix-rotate)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
...
(cffi:defcfun ("__claw_MatrixRotateX" raylib::matrix-rotate-x)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::angle :float))
...
(cffi:defcfun ("__claw_MatrixRotateXYZ" raylib::matrix-rotate-xyz)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
...
(cffi:defcfun ("__claw_MatrixRotateY" raylib::matrix-rotate-y)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::angle :float))
...
(cffi:defcfun ("__claw_MatrixRotateZ" raylib::matrix-rotate-z)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::angle :float))
...
(cffi:defcfun ("__claw_MatrixRotateZYX" raylib::matrix-rotate-zyx)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::angle (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_MatrixScale" raylib::matrix-scale)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::x :float)
              (raylib::y :float)
...
(cffi:defcfun ("__claw_MatrixSubtract" raylib::matrix-subtract)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::left (:pointer raylib::matrix))
              (raylib::right (:pointer raylib::matrix)))
...
(cffi:defcfun ("__claw_MatrixToFloatV" raylib::matrix-to-float-v)
...
(cffi:defcfun ("__claw_MatrixTrace" raylib::matrix-trace)
              :float
              (raylib::mat (:pointer raylib::matrix)))

(declaim (inline raylib::matrix-translate))

(cffi:defcfun ("__claw_MatrixTranslate" raylib::matrix-translate)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::x :float)
              (raylib::y :float)
...
(cffi:defcfun ("__claw_MatrixTranspose" raylib::matrix-transpose)
              (:pointer raylib::matrix)
              (raylib::%%claw-result- (:pointer raylib::matrix))
              (raylib::mat (:pointer raylib::matrix)))
...
(cffi:defcfun ("__claw_MeasureTextEx" raylib::measure-text-ex)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::font (:pointer raylib::font))
              (raylib::text :string)
...
(cffi:defcfun ("__claw_Normalize" raylib::normalize)
              :float
              (raylib::value :float)
              (raylib::start :float)
              (raylib::end :float))
...
(cffi:defcfun ("__claw_PauseAudioStream" raylib::pause-audio-stream)
              :void
              (raylib::stream (:pointer raylib::audio-stream)))

(declaim (inline raylib::pause-music-stream))

(cffi:defcfun ("__claw_PauseMusicStream" raylib::pause-music-stream)
              :void
              (raylib::music (:pointer raylib::music)))

(declaim (inline raylib::pause-sound))

(cffi:defcfun ("__claw_PauseSound" raylib::pause-sound)
              :void
              (raylib::sound (:pointer raylib::sound)))

(declaim (inline raylib::play-audio-stream))

(cffi:defcfun ("__claw_PlayAudioStream" raylib::play-audio-stream)
              :void
              (raylib::stream (:pointer raylib::audio-stream)))

(declaim (inline raylib::play-automation-event))

(cffi:defcfun ("__claw_PlayAutomationEvent"
...
(cffi:defcfun ("__claw_PlayMusicStream" raylib::play-music-stream)
              :void
              (raylib::music (:pointer raylib::music)))

(declaim (inline raylib::play-sound))

(cffi:defcfun ("__claw_PlaySound" raylib::play-sound)
              :void
              (raylib::sound (:pointer raylib::sound)))
...
(cffi:defcfun ("__claw_QuaternionAdd" raylib::quaternion-add)
...
(cffi:defcfun ("__claw_QuaternionDivide" raylib::quaternion-divide)
              (:pointer raylib::quaternion)
              (raylib::%%claw-result- (:pointer raylib::quaternion))
              (raylib::q1 (:pointer raylib::quaternion))
              (raylib::q2 (:pointer raylib::quaternion)))
...
(cffi:defcfun ("__claw_QuaternionEquals" raylib::quaternion-equals)
              :int
...
(cffi:defcfun ("__claw_QuaternionInvert" raylib::quaternion-invert)
              (:pointer raylib::quaternion)
              (raylib::%%claw-result- (:pointer raylib::quaternion))
              (raylib::q (:pointer raylib::quaternion)))
...
(cffi:defcfun ("__claw_QuaternionLength" raylib::quaternion-length)
              :float
              (raylib::q (:pointer raylib::quaternion)))

(declaim (inline raylib::quaternion-lerp))

(cffi:defcfun ("__claw_QuaternionLerp" raylib::quaternion-lerp)
              (:pointer raylib::quaternion)
              (raylib::%%claw-result- (:pointer raylib::quaternion))
              (raylib::q1 (:pointer raylib::quaternion))
              (raylib::q2 (:pointer raylib::quaternion))
...
(cffi:defcfun ("__claw_QuaternionNlerp" raylib::quaternion-nlerp)
              (:pointer raylib::quaternion)
              (raylib::%%claw-result- (:pointer raylib::quaternion))
              (raylib::q1 (:pointer raylib::quaternion))
              (raylib::q2 (:pointer raylib::quaternion))
...
(cffi:defcfun ("__claw_QuaternionScale" raylib::quaternion-scale)
              (:pointer raylib::quaternion)
              (raylib::%%claw-result- (:pointer raylib::quaternion))
              (raylib::q (:pointer raylib::quaternion))
              (raylib::mul :float))
...
(cffi:defcfun ("__claw_QuaternionSlerp" raylib::quaternion-slerp)
              (:pointer raylib::quaternion)
              (raylib::%%claw-result- (:pointer raylib::quaternion))
              (raylib::q1 (:pointer raylib::quaternion))
              (raylib::q2 (:pointer raylib::quaternion))
...
(cffi:defcfun ("__claw_Remap" raylib::remap)
              :float
              (raylib::value :float)
...
(cffi:defcfun ("__claw_ResumeSound" raylib::resume-sound)
              :void
              (raylib::sound (:pointer raylib::sound)))
...
(cffi:defcfun ("__claw_SeekMusicStream" raylib::seek-music-stream)
              :void
              (raylib::music (:pointer raylib::music))
...
(cffi:defcfun ("__claw_SetMusicPan" raylib::set-music-pan)
              :void
              (raylib::music (:pointer raylib::music))
              (raylib::pan :float))
...
(cffi:defcfun ("__claw_SetMusicPitch" raylib::set-music-pitch)
              :void
              (raylib::music (:pointer raylib::music))
              (raylib::pitch :float))
...
(cffi:defcfun ("__claw_SetMusicVolume" raylib::set-music-volume)
              :void
              (raylib::music (:pointer raylib::music))
              (raylib::volume :float))
...
(cffi:defcfun ("__claw_SetPixelColor" raylib::set-pixel-color)
              :void
...
(cffi:defcfun ("__claw_SetShaderValue" raylib::set-shader-value)
              :void
              (raylib::shader (:pointer raylib::shader))
...
(cffi:defcfun ("__claw_SetShaderValueV" raylib::set-shader-value-v)
              :void
              (raylib::shader (:pointer raylib::shader))
              (raylib::loc-index :int)
              (raylib::value (:pointer :void))
...
(cffi:defcfun ("__claw_SetShapesTexture" raylib::set-shapes-texture)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::source (:pointer raylib::rectangle)))
...
(cffi:defcfun ("__claw_SetSoundPan" raylib::set-sound-pan)
              :void
              (raylib::sound (:pointer raylib::sound))
              (raylib::pan :float))
...
(cffi:defcfun ("__claw_SetSoundPitch" raylib::set-sound-pitch)
              :void
              (raylib::sound (:pointer raylib::sound))
              (raylib::pitch :float))
...
(cffi:defcfun ("__claw_SetSoundVolume" raylib::set-sound-volume)
              :void
              (raylib::sound (:pointer raylib::sound))
              (raylib::volume :float))
...
(cffi:defcfun ("__claw_SetTextureFilter" raylib::set-texture-filter)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::filter :int))
...
(cffi:defcfun ("__claw_SetTextureWrap" raylib::set-texture-wrap)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::wrap :int))

(cffi:defctype raylib::trace-log-callback (:pointer :void))

(declaim (inline raylib::set-trace-log-callback))

(cffi:defcfun ("SetTraceLogCallback" raylib::set-trace-log-callback)
              :void
              (raylib::callback raylib::trace-log-callback))
...
(cffi:defcfun ("__claw_SetWindowIcon" raylib::set-window-icon)
              :void
              (raylib::image (:pointer raylib::image)))
...
(cffi:defcfun ("__claw_StopAudioStream" raylib::stop-audio-stream)
              :void
              (raylib::stream (:pointer raylib::audio-stream)))
...
(cffi:defcfun ("__claw_StopMusicStream" raylib::stop-music-stream)
              :void
              (raylib::music (:pointer raylib::music)))

(declaim (inline raylib::stop-sound))

(cffi:defcfun ("__claw_StopSound" raylib::stop-sound)
              :void
              (raylib::sound (:pointer raylib::sound)))
...
(cffi:defcfun ("__claw_UnloadFont" raylib::unload-font)
              :void
              (raylib::font (:pointer raylib::font)))
...
(cffi:defcfun ("__claw_UnloadImage" raylib::unload-image)
              :void
              (raylib::image (:pointer raylib::image)))
...
(cffi:defcfun ("__claw_UnloadMaterial" raylib::unload-material)
              :void
              (raylib::material (:pointer raylib::material)))

(declaim (inline raylib::unload-mesh))

(cffi:defcfun ("__claw_UnloadMesh" raylib::unload-mesh)
              :void
              (raylib::mesh (:pointer raylib::mesh)))

(declaim (inline raylib::unload-model))

(cffi:defcfun ("__claw_UnloadModel" raylib::unload-model)
              :void
              (raylib::model (:pointer raylib::model)))
...
(cffi:defcfun ("__claw_UnloadShader" raylib::unload-shader)
              :void
              (raylib::shader (:pointer raylib::shader)))

(declaim (inline raylib::unload-sound))

(cffi:defcfun ("__claw_UnloadSound" raylib::unload-sound)
              :void
              (raylib::sound (:pointer raylib::sound)))

(declaim (inline raylib::unload-sound-alias))

(cffi:defcfun ("__claw_UnloadSoundAlias" raylib::unload-sound-alias)
              :void
              (raylib::alias (:pointer raylib::sound)))

(declaim (inline raylib::unload-texture))

(cffi:defcfun ("__claw_UnloadTexture" raylib::unload-texture)
              :void
              (raylib::texture (:pointer raylib::texture-2d)))
...
(cffi:defcfun ("__claw_UnloadWave" raylib::unload-wave)
              :void
              (raylib::wave (:pointer raylib::wave)))
...
(cffi:defcfun ("__claw_UpdateCameraPro" raylib::update-camera-pro)
              :void
              (raylib::camera (:pointer raylib::camera))
...
(cffi:defcfun ("__claw_UpdateMeshBuffer" raylib::update-mesh-buffer)
              :void
              (raylib::mesh (:pointer raylib::mesh))
              (raylib::index :int)
              (raylib::data (:pointer :void))
...
(cffi:defcfun ("__claw_UpdateSound" raylib::update-sound)
              :void
              (raylib::sound (:pointer raylib::sound))
              (raylib::data (:pointer :void))
...
(cffi:defcfun ("__claw_UpdateTexture" raylib::update-texture)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
...
(cffi:defcfun ("__claw_UpdateTextureRec" raylib::update-texture-rec)
              :void
              (raylib::texture (:pointer raylib::texture-2d))
              (raylib::rec (:pointer raylib::rectangle))
              (raylib::pixels (:pointer :void)))
...
(cffi:defcfun ("__claw_Vector2Add" raylib::vector2-add)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2AddValue" raylib::vector2-add-value)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
...
(cffi:defcfun ("__claw_Vector2Angle" raylib::vector2-angle)
              :float
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2Clamp" raylib::vector2-clamp)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2))
...
(cffi:defcfun ("__claw_Vector2Distance" raylib::vector2-distance)
              :float
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2Divide" raylib::vector2-divide)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2Equals" raylib::vector2-equals)
              :int
...
(cffi:defcfun ("__claw_Vector2Invert" raylib::vector2-invert)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2Length" raylib::vector2-length)
              :float
              (raylib::v (:pointer raylib::vector2)))

(declaim (inline raylib::vector2-length-sqr))

(cffi:defcfun ("__claw_Vector2LengthSqr" raylib::vector2-length-sqr)
              :float
              (raylib::v (:pointer raylib::vector2)))

(declaim (inline raylib::vector2-lerp))

(cffi:defcfun ("__claw_Vector2Lerp" raylib::vector2-lerp)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2))
...
(cffi:defcfun ("__claw_Vector2LineAngle" raylib::vector2-line-angle)
              :float
              (raylib::start (:pointer raylib::vector2))
              (raylib::end (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2Multiply" raylib::vector2-multiply)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2Negate" raylib::vector2-negate)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2Normalize" raylib::vector2-normalize)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_cE3AE40FE40Vector2One" raylib::vector2-one)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2)))

(declaim (inline raylib::vector2-reflect))

(cffi:defcfun ("__claw_Vector2Reflect" raylib::vector2-reflect)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2))
...
(cffi:defcfun ("__claw_Vector2Rotate" raylib::vector2-rotate)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2))
              (raylib::angle :float))
...
(cffi:defcfun ("__claw_Vector2Scale" raylib::vector2-scale)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2))
              (raylib::scale :float))
...
(cffi:defcfun ("__claw_Vector2Subtract" raylib::vector2-subtract)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2)))
...
(cffi:defcfun ("__claw_Vector2Transform" raylib::vector2-transform)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2))
              (raylib::mat (:pointer raylib::matrix)))
...
(cffi:defcfun ("__claw_cE3AE40FE40Vector2Zero" raylib::vector2-zero)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2)))

(declaim (inline raylib::vector3-add))

(cffi:defcfun ("__claw_Vector3Add" raylib::vector3-add)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3AddValue" raylib::vector3-add-value)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_Vector3Angle" raylib::vector3-angle)
              :float
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Barycenter" raylib::vector3-barycenter)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_Vector3Clamp" raylib::vector3-clamp)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_Vector3Distance" raylib::vector3-distance)
              :float
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Divide" raylib::vector3-divide)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Equals" raylib::vector3-equals)
              :int
              (raylib::p (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_Vector3Invert" raylib::vector3-invert)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Length" raylib::vector3-length)
              :float
              (raylib::v (:pointer raylib::vector3)))

(declaim (inline raylib::vector3-length-sqr))

(cffi:defcfun ("__claw_Vector3LengthSqr" raylib::vector3-length-sqr)
              :float
              (raylib::v (:pointer raylib::vector3)))

(declaim (inline raylib::vector3-lerp))

(cffi:defcfun ("__claw_Vector3Lerp" raylib::vector3-lerp)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_Vector3Max" raylib::vector3-max)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Min" raylib::vector3-min)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Multiply" raylib::vector3-multiply)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Negate" raylib::vector3-negate)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Normalize" raylib::vector3-normalize)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_cE3AE40FE40Vector3One" raylib::vector3-one)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Project" raylib::vector3-project)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Reflect" raylib::vector3-reflect)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_Vector3Refract" raylib::vector3-refract)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_Vector3Reject" raylib::vector3-reject)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3Scale" raylib::vector3-scale)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3))
              (raylib::scalar :float))
...
(cffi:defcfun ("__claw_Vector3Subtract" raylib::vector3-subtract)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_Vector3ToFloatV" raylib::vector3-to-float-v)
...
(cffi:defcfun ("__claw_Vector3Transform" raylib::vector3-transform)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3))
              (raylib::mat (:pointer raylib::matrix)))
...
(cffi:defcfun ("__claw_Vector3Unproject" raylib::vector3-unproject)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_cE3AE40FE40Vector3Zero" raylib::vector3-zero)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3)))
...
(cffi:defcfun ("__claw_WaveCopy" raylib::wave-copy)
              (:pointer raylib::wave)
              (raylib::%%claw-result- (:pointer raylib::wave))
              (raylib::wave (:pointer raylib::wave)))
...
(cffi:defcfun ("__claw_Wrap" raylib::wrap)
              :float
              (raylib::value :float)
              (raylib::min :float)
              (raylib::max :float))
...
(cffi:defcstruct (raylib::long-double :class
                  raylib::emulated$long-double :size 12)
                 (raylib::data :unsigned-char :count 12))
...
(cffi:defcfun ("__claw_acoshl" raylib::acoshl)
...
(cffi:defcfun ("__claw_acosl" raylib::acosl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_asinhl" raylib::asinhl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_asinl" raylib::asinl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_atan2l" raylib::atan2l)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
...
(cffi:defcfun ("__claw_atanhl" raylib::atanhl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_atanl" raylib::atanl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_cbrtl" raylib::cbrtl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_ceill" raylib::ceill)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_copysignl" raylib::copysignl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_coshl" raylib::coshl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_cosl" raylib::cosl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_cE3AE40FE40erfcl" raylib::erfcl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
...
(cffi:defcfun ("__claw_cE3AE40FE40erfl" raylib::erfl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::arg0 (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_exp2l" raylib::exp2l)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_expl" raylib::expl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_expm1l" raylib::expm1l)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_fabsl" raylib::fabsl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_fdiml" raylib::fdiml)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_floorl" raylib::floorl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_fmal" raylib::fmal)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double))
...
(cffi:defcfun ("__claw_fmaxl" raylib::fmaxl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_fminl" raylib::fminl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_fmodl" raylib::fmodl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))

(declaim (inline raylib::frexp))

(cffi:defcfun ("frexp" raylib::frexp)
              :double
              (raylib::%%x :double)
              (raylib::%%exponent (:pointer :int)))

(declaim (inline raylib::frexpf))

(cffi:defcfun ("frexpf" raylib::frexpf)
              :float
              (raylib::%%x :float)
              (raylib::%%exponent (:pointer :int)))
...
(cffi:defcfun ("__claw_frexpl" raylib::frexpl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%exponent (:pointer :int)))
...
(cffi:defcfun ("__claw_hypotl" raylib::hypotl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_ilogbl" raylib::ilogbl)
              :int
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_ldexpl" raylib::ldexpl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%exponent :int))
...
(cffi:defcfun ("__claw_llrintl" raylib::llrintl)
              :long-long
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_llroundl" raylib::llroundl)
              :long-long
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_log10l" raylib::log10l)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_log1pl" raylib::log1pl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_log2l" raylib::log2l)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_logbl" raylib::logbl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_logl" raylib::logl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_lrintl" raylib::lrintl)
              :long
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_lroundl" raylib::lroundl)
              :long
              (raylib::%%x (:pointer raylib::long-double)))

(declaim (inline raylib::modf))

(cffi:defcfun ("modf" raylib::modf)
              :double
              (raylib::%%x :double)
              (raylib::%%iptr (:pointer :double)))

(declaim (inline raylib::modff))

(cffi:defcfun ("modff" raylib::modff)
              :float
              (raylib::%%x :float)
              (raylib::%%iptr (:pointer :float)))

(declaim (inline raylib::modfl))

(cffi:defcfun ("__claw_modfl" raylib::modfl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%iptr (:pointer raylib::long-double)))

(declaim (inline raylib::nan))

(cffi:defcfun ("nan" raylib::nan) :double (raylib::%%tagb :string))

(declaim (inline raylib::nanf))

(cffi:defcfun ("nanf" raylib::nanf) :float (raylib::%%tagb :string))

(declaim (inline raylib::nanl))

(cffi:defcfun ("__claw_nanl" raylib::nanl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%tagb :string))
...
(cffi:defcfun ("__claw_nearbyintl" raylib::nearbyintl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_nextafterl" raylib::nextafterl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_nexttoward" raylib::nexttoward)
              :double
              (raylib::%%x :double)
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_nexttowardf" raylib::nexttowardf)
              :float
              (raylib::%%x :float)
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_nexttowardl" raylib::nexttowardl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_powl" raylib::powl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_remainderl" raylib::remainderl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double)))

(declaim (inline raylib::remquo))

(cffi:defcfun ("remquo" raylib::remquo)
              :double
              (raylib::%%x :double)
              (raylib::%%y :double)
              (raylib::%%quo (:pointer :int)))

(declaim (inline raylib::remquof))

(cffi:defcfun ("remquof" raylib::remquof)
              :float
              (raylib::%%x :float)
              (raylib::%%y :float)
              (raylib::%%quo (:pointer :int)))
...
(cffi:defcfun ("__claw_remquol" raylib::remquol)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%y (:pointer raylib::long-double))
...
(cffi:defcfun ("__claw_rintl" raylib::rintl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_roundl" raylib::roundl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_sinhl" raylib::sinhl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_sinl" raylib::sinl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_sqrtl" raylib::sqrtl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_tanhl" raylib::tanhl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_tanl" raylib::tanl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defcfun ("__claw_truncl" raylib::truncl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double)))
...
(cffi:defctype raylib::va-list (:pointer :void))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export 'raylib::trace-log-callback :raylib)
  ...
  (export 'raylib::set-trace-log-callback :raylib)

...
(cffi:defcstruct (raylib::std+--va-list :size 32)
                 (raylib::%%stack (:pointer :void) :offset 0)
                 (raylib::%%gr-top (:pointer :void) :offset 8)
                 (raylib::%%vr-top (:pointer :void) :offset 16)
                 (raylib::%%gr-offs :int :offset 24)
                 (raylib::%%vr-offs :int :offset 28))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export 'raylib::std+--va-list :raylib)
